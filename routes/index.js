...
api.get('/reestablecer', usuarioController.formReestablecerPassword)
api.post('/reestablecer', authController.enviarToken)
api.get('/reestablecer/:token', authController.validarToken)
api.post('/reestablecer/:token', authController.actualizarPassword)
api.get('/confirmar/:email', usuarioController.confirmarCuenta)
module.exports = api 